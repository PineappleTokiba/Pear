const MODULES = {
  ...
  battery: { number: 'PART 04', name: 'Battery', summary: 'A protected power cell that is removable, solderless, and built for safe replacement.', why: 'Battery aging is one of the most common reasons an otherwise functional phone gets replaced.', how: 'The battery is secured inside its module and screwed directly into the phone’s case for a stable, reliable fit.' },
